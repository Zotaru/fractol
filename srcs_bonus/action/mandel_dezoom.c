...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/10 21:50:02 by amonier           #+#    #+#             */
/*   Updated: 2023/05/16 22:14:04 by amonier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	temp_axe(t_scale *axe, t_mcaliber mouse, float distance_x,
		float distance_y)
{
	axe->x_min = mouse.x - (distance_x / 1.5);
	axe->x_max = mouse.x + (distance_x / 1.5);
	axe->y_min = mouse.y - (distance_y / 1.5);
	axe->y_max = mouse.y + (distance_y / 1.5);
}
